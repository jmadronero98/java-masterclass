...
public class a_41readingUserInputChallenge {
    public static void main (String[]args) {
        ...
        System.out.println(sum + " is the sum of all");
        scanner.close();
    }
}
        ...
        //For example, the first message printed to the user would be "Enter number #1:", the next
